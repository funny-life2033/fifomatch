...
internal class QualitiesAdapter(private val list: ArrayList<String>) : RecyclerView.Adapter<QualitiesAdapter.NotificationViewHolder>() {

    private var selectionPositions= hashSetOf<String>()

    internal inner class NotificationViewHolder(binding: ListQuaBinding) :
    ...
    fun updateSelectedValues(selectedPosi: HashSet<String>) {
       this.selectionPositions = selectedPosi
